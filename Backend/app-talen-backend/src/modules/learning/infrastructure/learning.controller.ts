...
export class LearningController {
  ...
  @ApiOperation({ summary: 'Generar ruta de aprendizaje personalizada', description: 'Crea una ruta de aprendizaje adaptada al usuario autenticado.' })
  @ApiBody({ type: GenerateLearningPathDto, description: 'Datos para generar la ruta de aprendizaje.' })
  @ApiResponse({ status: 201, description: 'Ruta de aprendizaje generada.', type: LearningPath })
  ...
  @ApiOperation({ summary: 'Listar mis rutas de aprendizaje', description: 'Devuelve todas las rutas de aprendizaje del usuario autenticado.' })
  @ApiResponse({ status: 200, description: 'Lista de rutas de aprendizaje.', type: [LearningPath] })
  findMyLearningPaths(
    @Req() request: AuthenticatedRequest,
  ): Promise<LearningPath[]> {
  ...
  @ApiOperation({ summary: 'Listar mis módulos de aprendizaje', description: 'Devuelve todos los módulos de aprendizaje asignados al usuario autenticado.' })
  @ApiResponse({ status: 200, description: 'Lista de módulos de aprendizaje.', type: [LearningModuleEntity] })
  ...
  @ApiOperation({ summary: 'Actualizar progreso de módulo', description: 'Permite actualizar el progreso de un módulo de aprendizaje específico.' })
  @ApiParam({ name: 'moduleId', description: 'ID del módulo de aprendizaje.' })
  @ApiBody({ type: UpdateModuleProgressDto, description: 'Datos de progreso a actualizar.' })
  @ApiResponse({ status: 200, description: 'Progreso actualizado.', type: UserModuleProgress })
